...
//	    h_.writeText("<div id=\"gc-container\" style=\"padding-left:1em;padding-right:1em;\" id=\"pagecontent\">");
	    ...
	    h_.writeText("<nobr><a href=\"http://developer.android.com\" target=\"_top\">Android Developers</a> | <a href=\"http://www.android.com\" target=\"_top\">Android.com</a></nobr>");
	    h_.writeText("</span>");
	    h_.writeText("</div>");
	    ...
	    h_.writeText("      </tr>");
//	    h_.writeText("      <tr>");
//	    h_.writeText("        <td class=\"diffspec\">Product Type:</td>");
//	    h_.writeText("        <td class=\"diffvalue\">Generic</td>");
//	    h_.writeText("      </tr>");
	    h_.writeText("      <tr>");
...
//	    h_.writeText("<div id=\"codesiteContent\" style=\"margin-top: 70px;margin-bottom:80px;\">");
	    ...
	    h_.writeText("<div id=\"mainBodyFluid\">");
            ...
            //h_.writeText("<div style=\"margin-left:2em;\"><h2>Contents</h2>");
            ...
            //h_.writeText("<dt><a href=\"#numbers\">Total of Differences</a></dt><dd>Listed by number and type</dd></dl></div>");
            ...
            h_.writeText("        <a href=\"http://creativecommons.org/licenses/by/2.5/\"> Creative Commons Attribution 2.5</a>."); 
            h_.writeText("        For details and restrictions, see the <a href=\"/license.html\">Content License</a>."); 
            h_.writeText("        </div>"); 
            h_.writeText("      <div id=\"footerlinks\">"); 
            h_.writeText("      <p>"); 
            h_.writeText("        <a href=\"http://www.android.com/terms.html\">Site Terms of Service</a> -"); 
            h_.writeText("        <a href=\"http://www.android.com/privacy.html\">Privacy Policy</a> -"); 
            h_.writeText("        <a href=\"http://www.android.com/branding.html\">Brand Guidelines</a>"); 
            h_.writeText("      </p>"); 
            h_.writeText("    </div>"); 
